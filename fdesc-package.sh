...
rpmlint ~/rpmbuild/SRPMS/fdesc-0-1.fc34.src.rpm

# build and lint RPM
rpmbuild -bb ~/rpmbuild/SPECS/fdesc.spec
rpmlint ~/rpmbuild/RPMS/x86_64/fdesc-0-1.fc34.x86_64.rpm

# Building in Copr
copr-cli build fdesc ~/rpmbuild/SRPMS/fdesc-0-1.fc34.src.rpm
